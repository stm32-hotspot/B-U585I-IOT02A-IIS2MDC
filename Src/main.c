...
int main(void)
{
  ...
  IIS2MDC_io_ctx.Init = CUSTOM_IIS2MDC_0_I2C_Init;
  IIS2MDC_io_ctx.DeInit = CUSTOM_IIS2MDC_0_I2C_DeInit;
  IIS2MDC_io_ctx.ReadReg = CUSTOM_IIS2MDC_0_I2C_ReadReg;
  IIS2MDC_io_ctx.WriteReg = CUSTOM_IIS2MDC_0_I2C_WriteReg;
